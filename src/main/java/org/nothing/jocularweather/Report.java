...
/**
 * Parent class for JSON object from weather report. Follows {@link <a href="https://openweathermap.org/current#current_JSON">...</a>}
 *
...
/**
 * Further deatils about weather. Temperature units determined by API call
 *
 ...
 * @param pressure   barometric sea-level equivalent pressure in hPa, if sea_level/grnd_level fields aren't provided
